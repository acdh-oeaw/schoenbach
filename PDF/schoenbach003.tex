...
\chead{\textsc{fünf briefe an anton e. schönbach}}
\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \pstart\begin{center}
           \noindent{}{\pb}\Large\textcolor{gray}{\textbf{Ferdinand von Saar}}\end{center}\pend
           
           \pstart erlaubt sich,
                    verehrungsvollst herzliche Glückwünsche darzubringen.\pend
           \pstart \textit{Wien – Döbling}\oindex{XIX., Doebling@\textbf{XIX., Döbling}|pw}.
                    20/10.1905’\pend{}
         
         \endnumbering\mylabel{h}\end{ledgroupsized}\begin{anhang}\end{anhang}\newcommand{\dateiname}{schoenbach003}\newcommand{\titel}{Ferdinand von Saar an Anton Emanuel Schönbach, 20. 10. 1905}\newcommand{\editorInnen}{Konstanze Fliedl, Anna Lindner, Martin Anton Müller und Laura Untner}
