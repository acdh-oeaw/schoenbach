...
\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]}  \pstart{}{\pb}Hochwohlgeboren\pend{}\pstart{}Frau Hofrat Anna Schönbach\pend{}\pstart{}Graz\oindex{Graz@\textbf{Graz}|pw}\pend{}\pstart{}Glacisstraße 9\oindex{Glacisstrasse@\textbf{Glacisstraße}|pw}.\pend{}{\bigskip}\pstart
           \raggedleft{}{\pb}Zdisslawitz Post Zdounek Mähren\oindex{Zdislavice@\textbf{Zdislavice}|pw}{ }\\1. Sept. 911.\pend
           \pstart{}Hochverehrte teure Frau!\pend\pstart
           Auf das Tiefste ergriffen durch die eben empfangene Trauerbotschaft des Todes
                    Ihres edlen Gatten\pwindex{Schoenbach, Anton Emanuel 1848-05-29 – 1911-08-25@\textit{Schönbach, Anton Emanuel} (1848-05-29 – 1911-08-25), \emph{Germanist}|pw}, erlaube ich mir, Ihnen
                    mein wärmstes Beileid, mein innigstes Mitgefühl auszusprechen. Er stand auf der
                    Höhe {\pb}seines reichen Lebens, wir waren stolz auf ihn, er war uns
                    Lehrer und Führer und für so viele ein Vorbild.\pend
           \pstart
           Wer würde nach einem Verluste wie den, den Sie erleiden, von Trost sprechen
                    dürfen und wer würde es wagen ihn spenden zu wollen? So wiederhole ich denn nur,
                    hochverehrte teure Frau: Zu den Tausenden, die mit Ihnen {\pb}trauern aus vollem Herzen, in Ehrfurcht und Dankbarkeit, zählt auch\pend
           \pstart
           Ihre ergebene {\\[\baselineskip]}\spacefill\mbox{Marie Ebner-Eschenbach}\pend
           \leftskip=0em{}
         
         \endnumbering\mylabel{h}\end{ledgroupsized}\begin{anhang}\end{anhang}\newcommand{\dateiname}{schoenbach005}\newcommand{\titel}{Marie von Ebner-Eschenbach an Anna Schönbach, 1. 9. 1911}\newcommand{\editorInnen}{Konstanze Fliedl, Anna Lindner, Martin Anton Müller und Laura Untner}
         \bigskip
