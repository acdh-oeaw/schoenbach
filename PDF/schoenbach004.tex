...
\newcommand\pwindex[1]{{\sindex{#1}}}
\newcommand\oindex[1]{{\sindex{#1}}}
\newcommand\orgindex[1]{{\sindex{#1}}}
...
\chead{\textit{schnitzler: \emph{briefwechsel}}}
\chead{\textit{fünf briefe an anton e. schönbach}}
\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \toendnotes[C]{\smallbreak}\pstart
           \raggedleft{}{\pb}\textit{Blansko} in Mähren\oindex{Blansko@\textbf{Blansko}|pw}; 3' Januar 1888.\pend
           \pstart{}Hochverehrter Herr Regierungsrath!\pend\pstart
           Ich kann das neue Jahr nicht besser beginnen, als in dem
                    ich Ihnen danke. Es wurde mir nämlich von befreundeter Hand unter Kreuzband ein
                    kleines Buch\pwindex{Schoenbach, Anton Emanuel 1848-05-29 – 1911-08-25@\textit{Schönbach, Anton Emanuel} (1848-05-29 – 1911-08-25), \emph{Germanist}!Ueber Lesen und Bildung. Umschau und Ratschlaege1888@\strich\emph{Über Lesen und Bildung. Umschau und Ratschläge} {[}1888{]}|pwv} zugesendet, in
                    welchem meiner Novellen in so
                    auszeichnender Weise gedacht wird. Aber nicht allein für diese mich
                    hocherfreuende und fördernde Anerkenung muß ich Ihnen danken: sondern auch für
                    den geistigen Genuß, den mir das Werk\pwindex{Schoenbach, Anton Emanuel 1848-05-29 – 1911-08-25@\textit{Schönbach, Anton Emanuel} (1848-05-29 – 1911-08-25), \emph{Germanist}!Ueber Lesen und Bildung. Umschau und Ratschlaege1888@\strich\emph{Über Lesen und Bildung. Umschau und Ratschläge} {[}1888{]}|pwv} selbst in seiner so überaus vornehmen Haltung und durch die
                    tiefen Wahrheiten, die es ausspricht, bereitet hat. Schon lange bevor ich es
                    erhielt, hatte ich meinen Verleger\orgindex{Georg Weiss Verlag@Georg Weiß Verlag|pwv}
                    beauftragt, Ihnen ein Exemplar der zweiten, um ein {\pb}gutes
                    Drittel vermehrten Auflage meiner Gedichte\pwindex{Saar, Ferdinand von 30.09.1833 – 24.07.1906@\textit{Saar, Ferdinand von} (30.09.1833 – 24.07.1906), \emph{Schriftsteller}!Gedichte. 2. durchgesehene und vermehrte Auflage1888@\strich\emph{Gedichte. 2. durchgesehene und vermehrte Auflage} {[}1888{]}|pwv} zu übersenden; denn Sie werden wohl selbst fühlen, wie sehr
                    ich wünschen müßte, daß meine Schriften von Ihnen gekannt seien – und mit den
                    Gedichten\pwindex{Saar, Ferdinand von 30.09.1833 – 24.07.1906@\textit{Saar, Ferdinand von} (30.09.1833 – 24.07.1906), \emph{Schriftsteller}!Gedichte. 2. durchgesehene und vermehrte Auflage1888@\strich\emph{Gedichte. 2. durchgesehene und vermehrte Auflage} {[}1888{]}|pwv} wollte ich den
                    Anfang machen. Manche, so darf ich hoffen, werden Ihnen gefallen, ich spreche
                    daher die herzliche Bitte aus, das Buch\pwindex{Saar, Ferdinand von 30.09.1833 – 24.07.1906@\textit{Saar, Ferdinand von} (30.09.1833 – 24.07.1906), \emph{Schriftsteller}!Gedichte. 2. durchgesehene und vermehrte Auflage1888@\strich\emph{Gedichte. 2. durchgesehene und vermehrte Auflage} {[}1888{]}|pwv} mit liebevoller Aufmerksamkeit vorzunehmen und gewogen zu
                    bleiben,\pend
           \pstart
           wahrhaft verehrter Herr, {\\[\baselineskip]}Ihrem {\\[\baselineskip]}tief ergebenen {\\[\baselineskip]}\spacefill\mbox{Ferdinand von \textit{Saar}.}\pend
           \leftskip=0em{}
         
         \endnumbering\mylabel{h}\end{ledgroupsized}\begin{anhang}\end{anhang}\newcommand{\dateiname}{schoenbach004}\newcommand{\titel}{Ferdinand von Saar an Anton Emanuel Schönbach, 3. 1. 1888}\newcommand{\editorInnen}{Konstanze Fliedl, Anna Lindner, Martin Anton Müller und Laura Untner}
         \bigskip
