...
\chead{\textit{saar an anton e. schönbach}}

\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} 

\pstart
           \raggedleft{}{\pb}\textit{Habrovan} in Mähren\oindex{Habrovany@\textbf{Habrovany}|pw}. {\\}3' \textit{December} 1898.\pend
           \pstart{}Hochverehrter Herr!\pend\pstart
           Gestatten Sie, daß ich Ihnen zur empfangenen hohen Auszeichnung vom Herzen Glück
                    wünsche. Mein überlanges Schweigen mögen Sie gütigst nicht als Beweis ansehen,
                    daß ich Ihrer warmen, mich so sehr fördernden Anerkenung vergessen habe. Das
                    Gegentheil ist der Fall und ich hoffe in einer meiner nächsten Novellenbücher
                    darthun zu können, wie sehr ich mich Ihnen zu immerwährender Dankbarkeit
                    verpflichtet fühle.\pend
           \pstart
           In tiefer Ergebenheit {\\[\baselineskip]}\spacefill\mbox{Ferdinand von \textit{Saar}.}\pend
           \leftskip=0em{}
         
         \endnumbering\mylabel{h}\end{ledgroupsized}\begin{anhang}\end{anhang}\newcommand{\dateiname}{schoenbach001}\newcommand{\titel}{Ferdinand von Saar an Anton Emanuel Schönbach, 3. 12. 1898}\newcommand{\editorInnen}{Konstanze Fliedl, Anna Lindner, Martin Anton Müller und Laura Untner}
         \bigskip
