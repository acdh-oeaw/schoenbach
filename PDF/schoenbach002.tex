...
\toendnotes[C]{\smallbreak}\pstart
           \raggedleft{}{\pb}\textit{Blansko} in
                            Mähren\oindex{Blansko@\textbf{Blansko}|pw}; 30t. \textit{October} 1888.\pend
           ...
           Seit langem hat mir nichts so große Freude bereitet wie Ihre anerkennenden und so
                    ...
                    schönsten Hoffnungen für die Zukunft hin. Ihrer {\pb}so überaus
                    liebenswürdigen Einladung, für die ich wärmstens danke, werde ich freilich in
                    diesem Winter kaum folgen können. Den erstens bin ich schon hier und in Wien\oindex{Wien@\textbf{Wien}|pw} verpflichtet – und zweitens wird mir in
                    ...
                    traurig genug ist, noch den Rest geben {\dotsfive}\pend
           \pstart
           Daß Sie in meinen Novellen die \textcolor{black}{oesterreich\oindex{Oesterreich@\textbf{Österreich}|pw}ge} Luft geschmeckt, war mir eine Freude zu
                    vernehmen. Ja, nur ein Oesterreich\oindex{Oesterreich@\textbf{Österreich}|pw}er kann
                    diese kleinen Schöpfungen verstehen und {\pb}genießen – trotz ihrer
                    Mängel und Schwächen. Was nun den Titel des Buches\pwindex{Saar, Ferdinand von 30.09.1833 – 24.07.1906@\textit{Saar, Ferdinand von} (30.09.1833 – 24.07.1906), \emph{Schriftsteller}!Schicksale. Drei Novellen (Der Novellen dritte Sammlung)1888-10-13@\strich\emph{Schicksale. Drei Novellen (Der Novellen dritte Sammlung)} {[}1888-10-13{]}|pwv} betrifft, so muß ich Ihnen nach einiger Überlegung
                    vollständig Recht geben; zu ändern ist die Sache nicht mehr – leider!
                    Hinsichtlich der »Troglodytin\pwindex{Saar, Ferdinand von 30.09.1833 – 24.07.1906@\textit{Saar, Ferdinand von} (30.09.1833 – 24.07.1906), \emph{Schriftsteller}!Troglodytin1888-08-01@\strich\emph{Die Troglodytin} {[}1888-08-01{]}|pw}« möchte ich nur sagen,
                    daß nicht der Adjunkt, sondern der alternde, durch das Leben gereifte \uline{Forstmeister} die Geschichte aus der Erinnerung
                    heraus erzählt. \textcolor{black}{Demnach} mag der Ton nicht ganz richtig sein –
                    Sie hätten sonst gewiß nicht das Gefühl davon gehabt. Aber das ist überhaupt die
                    mißliche Seite der »Ich-Geschichten.« –\pend
           \pstart\enlargethispage{2em}
           Daß Ihr Buch »über Lesen und
                    Bildung«\pwindex{Schoenbach, Anton Emanuel 1848-05-29 – 1911-08-25@\textit{Schönbach, Anton Emanuel} (1848-05-29 – 1911-08-25), \emph{Germanist}!Ueber Lesen und Bildung. Umschau und Ratschlaege1888@\strich\emph{Über Lesen und Bildung. Umschau und Ratschläge} {[}1888{]}|pwv} der dritten Auflage entgegen geht, ist ein höchst erfreulicher
                    ...
                    Erfolg, der ja auch mich fördert. Und so habe ich in mehr {\pb}als
                    ...
                    Ihnen ergeben ist\pend
           \pstart
           Ihr {\\[\baselineskip]}verehrungsvoller {\\[\baselineskip]}\spacefill\mbox{Ferdinand von \textit{Saar}.}\pend
           \leftskip=0em{}
         
         \endnumbering\mylabel{h}\end{ledgroupsized}\begin{anhang}\end{anhang}\newcommand{\dateiname}{schoenbach002}\newcommand{\titel}{Ferdinand von Saar an Anton Emanuel Schönbach, 30. 10. 1888}\newcommand{\editorInnen}{Konstanze Fliedl, Anna Lindner, Martin Anton Müller und Laura Untner}
