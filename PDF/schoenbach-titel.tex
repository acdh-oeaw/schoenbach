...
\begin{titlepage}
\begin{center}\Large{Fünf Briefe aus dem Splitternachlass von\\
Anton E. Schönbach im \\  Archiv der Österreichischen Akademie
der Wissenschaften}\end{center}


\vspace{2em}\normalsize\noindent Herausgegeben von den Mitarbeiterinnen und Mitarbeitern des Austrian Centre for Digital Humanities and Cultural Heritage (ACDH-CH) anlässlich des 
Antrittsbesuches des neuen Akademie-Präsidenten Heinz Fassmann am Institut, 14. November 2022

\vfill

           \begin{center}\large \url{https://schoenbach.acdh.oeaw.ac.at}
           \end{center}
\bigskip

\begin{itemize}
\item \textbf{Ferdinand von Saar an Anton Emanuel Schönbach, 3. 1. 1888}\\
{ Brief, 1 Blatt, 2 Seiten
\newline{}Handschrift: schwarze Tinte, deutsche Kurrent mit einzelnen Wörtern in Lateinschrift}
\item \textbf{Ferdinand von Saar an Anton Emanuel Schönbach, 30. 10. 1888}\\
{Brief, 2 Blätter, 4 Seiten
\newline{}Handschrift: schwarze Tinte, deutsche Kurrent}
\item \textbf{Ferdinand von Saar an Anton Emanuel Schönbach, 3. 12. 1898}\\
Brief, 1 Blatt, 1 Seite
\newline{}Handschrift: schwarze Tinte, deutsche Kurrent mit einzelnen Wörtern in Lateinschrift

\item \textbf{Ferdinand von Saar an Anton Emanuel Schönbach, 20. 10. 1905}\\
{Visitenkarte
\newline{}Handschrift: schwarze Tinte, deutsche Kurrent mit einzelnen Wörtern in Lateinschrift}
\item \textbf{Marie von Ebner-Eschenbach an Anna Schönbach, 1. 9. 1911}\\
{Brief, 1 Blatt, 3 Seiten, Umschlag
\newline{}Handschrift: schwarze Tinte, lateinische Kurrent\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{Zdislavice@\textbf{Zdislavice}|pwk}Zdislavice
                                                    (Zdounky)\nobreak{}«.  2) Stempel: »\nobreak{}\oindex{Borovnice@\textbf{Borovnice}|pwk}Zborowitz\nobreak{}«. \newline{}Umschlag mit Bleistift von unbekannter Hand
                                            beschriftet: »Ebner-Eschenbach« }
\end{itemize}
